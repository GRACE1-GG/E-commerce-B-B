...
const getProduct = (id: string) => {
  const products = [
    { id: 1, name: 'Premium Red Rose Bouquet', price: 2500, originalPrice: 3000, images: [
    ...
    ], category: 'Flowers', rating: 4.8, reviews: 124, inStock: true,
    description: 'Beautiful premium red roses arranged in an elegant bouquet...',
    specifications: { 'Number of Roses': '12 stems', 'Color': 'Deep Red' },
